...
export const UPGRADE_LABELS = {
  ...
  stoneGolemAncientCoreLevel: 'Golem Ancient Core',
  heroDestinedChampionLevel: 'Hero Champion',
  shieldDarkMetalLevel: 'Shield Dark Metal',
  monkHealCircleLevel: 'Monk Healing Circle',
  necroExpertSummonerLevel: 'Necro Revival',
  riderSuperHorseLevel: 'Rider Super Horse',
  diggerGoldFinderLevel: 'Digger Gold Finder',
  gunnerSkyCannonLevel: 'Gunner Sky Cannon',
  presidentExecutiveOrderLevel: 'President Executive Order',
