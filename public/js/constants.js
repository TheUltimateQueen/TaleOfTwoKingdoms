...
export const UPGRADE_LABELS = {
  ...
  stoneGolemAncientCoreLevel: 'Ancient Golem+',
  heroDestinedChampionLevel: 'Champion Hero+',
  shieldDarkMetalLevel: 'Dark Shield+',
  monkHealCircleLevel: 'Healing Monk+',
  necroExpertSummonerLevel: 'Revival Necro+',
  riderSuperHorseLevel: 'Super Rider+',
  diggerGoldFinderLevel: 'Gold Digger+',
  gunnerSkyCannonLevel: 'Cannon Gunner+',
